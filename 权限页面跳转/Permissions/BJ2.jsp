...
<body>
<h1 align="center"><font color="red">请确认信息是否提交!</font></h1>
...
<tr><td></td><td></td><td align="center"><a href="XG.jsp"><input type="button" name="XG" value="修改"></a><a href="Manage.jsp"><input type="button" name="tijiao" value="提交" onclick="ma()"></a></td></tr>
</table>
</body>
</html>