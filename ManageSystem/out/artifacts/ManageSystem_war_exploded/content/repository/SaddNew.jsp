...
<main class="clearfix" role="main">
    <div class="container">
        ...
        <br>
        <form action="<%=request.getContextPath()%>/servlet/repository/addnew/SnewSparePartsStorageServlet" method="post" onsubmit="return vilidate_form()"  accept-charset="UTF-8" autocomplete="off">
            <table style="margin-top: 30px" class="confermation-table" border="1px solid">
                ...
                <tr>
                    <th>备件名称</th>
                    <th><input type="text" id="a72" name="a72" class="customer-form-input" value="${AddnewNTN.getName()}" readonly></th>
                    <th>型号</th>
                    <th><input type="text" id="a73" name="a73" class="customer-form-input" value="${AddnewNTN.getType()}" readonly></th>
                <tr>
                    <th>单价</th>
                    <th><input type="number" id="a74" name="a74" class="customer-form-input" value="0"></th>
                    <th>数量</th>
                    <th><input type="number" id="a75" name="a75" class="customer-form-input" value="${AddnewNTN.getNumber()}" oninput="getstatu()"></th>
                </tr>
                <tr>
                    <th>出库时间</th>
                    ...
                    <th>警戒数量</th>
                    <th><input type="number" id="a76" name="a76" class="customer-form-input"  value="0" oninput="getstatu()"></th>
