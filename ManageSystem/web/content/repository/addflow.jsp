    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
                <span class="navbar-bar">
                    <a style="color: #5d594d;" href="htmlSrc/keeper.html">首页</a>
                    <a style="color: #5d594d;" href="addnew.jsp" class="selectPage">入库</a>
                    <a style="color: #5d594d;" href="htmlSrc/repairNeeded.html">出库</a>
                    <a style="color: #5d594d;" href="htmlSrc/select.html">查询库存</a>
