...
<main class="clearfix" role="main">
    <div class="container">
        ...
        <form action="<%=request.getContextPath()%>/servlet/repository/addflow/SaddflownewServlet" method="post">
            <table style="margin-top: 30px;" class="confermation-table" border="1px solid">
                ...
                <tr>
                    <th>入库时间</th>
                    <th colspan="3"><input type="date" id="a66" name="a66" class="customer-form-input" value="${requestScope.dateadd}" ></th>
                </tr>
            </table>
